...
import lt.laurynas.homework.account.entity.Account;
import lt.laurynas.homework.account.entity.AccountRecord;
...
public class AccountRepository {
    ...
    public List<RecordView> getRecords(String userEmail) {
        return em.createQuery("" +
                "SELECT new lt.laurynas.homework.account.view.RecordView(r.id, r.created, r.action, r.amount) " +
